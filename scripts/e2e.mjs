...
assert(result.response.status === 200 && result.body.legalVersion === LEGAL_VERSION && result.body.legalVersion === "2026-09-12.1", "/api/config must serve legal version 2026-09-12.1, the one the Worker validates intakes against");
