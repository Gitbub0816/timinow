...
///
/// One field. If Clerk knows the address you sign in; if it does not, an
/// account is created and the same code screen finishes the job. Nobody is
/// told "we couldn't find your account" and left there.
    ...
    private var subhead: String {
        ...
        case .code:
            return auth.isCreatingAccount
                ? "We sent a code to \(auth.pendingIdentifier) to finish setting up your account."
                : "We sent a code to \(auth.pendingIdentifier)."
        case .signedIn:
            return ""
        }
    }
    ...
    @ViewBuilder private var stageContent: some View {
        ...
        case .identifier:
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text("New here? Entering your email creates your account — there's no separate sign-up.")
