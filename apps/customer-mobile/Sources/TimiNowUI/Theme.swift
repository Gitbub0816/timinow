...
public enum TimiColor {
    public static let ink = Color(red: 0.067, green: 0.106, blue: 0.231)
    public static let paper = Color(red: 1.0, green: 0.980, blue: 0.941)
    public static let blue = Color(red: 0.137, green: 0.341, blue: 0.851)
    public static let blueSoft = Color(red: 0.898, green: 0.925, blue: 1.0)
    public static let coral = Color(red: 0.949, green: 0.373, blue: 0.298)
    public static let coralSoft = Color(red: 1.0, green: 0.898, blue: 0.875)
    public static let gold = Color(red: 0.969, green: 0.784, blue: 0.294)
    public static let goldSoft = Color(red: 1.0, green: 0.941, blue: 0.725)
    public static let canvas = Color(red: 0.965, green: 0.969, blue: 0.984)
    public static let muted = Color(red: 0.435, green: 0.455, blue: 0.514)
}

public struct TimiPrimaryButtonStyle: ButtonStyle {
    public var color: Color = TimiColor.coral
    public init(color: Color = TimiColor.coral) { self.color = color }
...
public struct TimiQuietButtonStyle: ButtonStyle {
    public init() { }
    public func makeBody(configuration: Configuration) -> some View {
        configuration.label
...
public enum TimiFormat {
    ...
    public static func wait(_ min: Int?, _ max: Int?) -> String {
