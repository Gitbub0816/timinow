...
const KNOWN_SCREENS = new Set(["sign-in", "workspace", "console", "overflow", "people", "legal"]);
...
async function renderRoute() {
  ...
  document.title = ({
    ...
    console: "Clinic operations · Tími Vet", overflow: "Overflow tools · Tími Vet",
    people: "People · Tími Vet", legal: "Legal · Tími Vet"
  })[route] || "Tími Vet";
