...
const CONTENT_SECURITY_POLICY = [
  ...
  // jsDelivr stays here, and only here: this is the one surface that loads
  // Stripe Connect JS (@stripe/connect-js) from it. Clerk left the CDN for
  // the Frontend API above, so the other three Workers no longer name
  // jsDelivr at all.
  ...
  "script-src 'self' https://clerk.timinow.pet https://cdn.jsdelivr.net https://api.mapbox.com https://static.cloudflareinsights.com",
  "style-src 'self' 'unsafe-inline' https://api.mapbox.com",
  "img-src 'self' data: blob: https://api.mapbox.com https://*.tiles.mapbox.com",
  "font-src 'self' data:",
  "connect-src 'self' https://clerk.timinow.pet https://api.stripe.com https://api.mapbox.com https://events.mapbox.com https://cloudflareinsights.com",
